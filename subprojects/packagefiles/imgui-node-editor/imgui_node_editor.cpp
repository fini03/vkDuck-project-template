...
inline void rectFloor(ImRect& v) {
    v.Min = ImFloor(v.Min);
    v.Max = ImFloor(v.Max);
}
...
void ed::NodeBuilder::PinRect(const ImVec2& a, const ImVec2& b)
{
    ...
    rectFloor(m_CurrentPin->m_Bounds);
